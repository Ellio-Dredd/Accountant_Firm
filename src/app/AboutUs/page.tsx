...
const AboutUs = () => {
  return (
    <section id="AboutUs" className="bg-gradient-to-b from-blue-50 to-white py-20">
      <div className="container mx-auto max-w-screen-lg px-4 space-y-16 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center transition-transform transform hover:scale-[1.02] duration-500">
          ...
          <p className="text-gray-700 text-lg leading-relaxed max-w-3xl mx-auto">
            Probity Accounts was founded by "ape client" in 2005 to provide accounting and tax services 
            to small and medium-sized businesses. Over the years, we have grown to become one of the 
            leading firms in the industry, providing a wide range of services to clients across various 
            sectors to help maintain their financial health and compliance.
          </p>
        </div>
