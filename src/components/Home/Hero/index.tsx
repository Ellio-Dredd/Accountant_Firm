        ...
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 pt-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1 items-center">
            ...
            <div className="col-span-6 flex flex-col gap-8">
              ...
              {/* Quality Labels */}
              <div className="flex flex-wrap justify-center lg:justify-between items-center gap-3 pt-10 lg:pt-4">
                {["Accurate", "Trustworthy", "Professional"].map(
                  (label, index) => (
            ...
            {/* RIGHT SIDE IMAGE */}
            <div className="col-span-6 flex justify-center mt-10 lg:mt-8 lg:ml-28">
              <Image
                src={"/images/banner/pexels-mikhail-nilov-8296990.jpg"}
